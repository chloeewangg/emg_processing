...
class EMGMuscleActivationMap:
    def __init__(self, file_path, sampling_rate=1000, window_size=0.1, max_amplitude=0.025,
        ...
        # Define the electrode positions in a 3x3 grid with middle empty
        # Channel mapping:
        # 6 8 7
        # 4   5  
        # 2 9 3
...
FILE_PATH = "C:/Users/chloe/OneDrive/Desktop/05_08_25 emg/bandpass_and_notch/yogurt 20 ml 2.txt"  # <-- CHANGE THIS to your data file path
SAMPLING_RATE = 1000         # EMG sampling rate in Hz
WINDOW_SIZE = 0.01           # Time window size in seconds
MAX_AMPLITUDE = 1        # Maximum EMG amplitude in mV for color scaling
PLOT_START_TIME = 6     # Start time (in seconds) for plotting
PLOT_END_TIME = 7   # End time (in seconds) for plotting
# =====================================================
